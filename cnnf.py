...
def CNN_F(input_image, weight_file, training, var_scope="CNN_F", reuse=False):
    ...
    with tf.variable_scope(var_scope, reuse=reuse):
        ...
        fc7 = current
        # fc7 = tf.squeeze(fc7)
        fc7 = tf.reshape(fc7, [-1, fc7.shape.as_list()[-1]], name="fc7")
...
def _conv_layer(input, weights, bias, pad, stride, i, ops, net):
    ...
    w = tf.get_variable('weight'+str(i), shape=weights.shape, dtype='float32',
